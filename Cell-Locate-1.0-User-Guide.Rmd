...
An example of the above description can be found in the following figure: The actual location of the device is represented as an American Robin. The cell tower can be found in the center of the yellow hexagon. Each of the three quadrilaterals within the yellow hexagon are hypothetical coverage areas of three antennas belonging to the same tower. If the robin falls within one of the areas, the fixed location will be reported as the device’s location. From the figure below, the robin fell in the “upper” area, so the location reported will correspond to the red marker. 


 <!-- Insert companion graphic here -->
...
* Approximately 2000 Cell-Locates on a single charge
* 34 mW Solar cell
* Can fully charge battery in ~4 hours
* Global LTE coverage

# Photos
![*Cell Locate on American Robin*](images/AMRO_CLT_Release-med.png){#id .class width=50%}

***

![*3.5g Cell Locate*](images/IMG_8824.JPG){#id .class width=50%}
