...
title: |
  ...
  <br />
  Flicker CL (Cell-Locate) 1.0 User Guide
...
The CTT Flicker CL (Cell-Locate) transmitter is the first of its kind to use the global cell network as a means of data transmission and for estimating the location of your tagged animal. In doing so we have reduced the weight of the fully-functional unit to nearly 3 grams and with a programming scheme that can allow over a year's worth of transmissions on a single charge of the battery. Since each device also has a solar panel, any amount of light will extend the life and performance of your Flicker CL device.
...
* Device weight starts at 3 grams (external wire antenna) or 3.8g (internal atenna)
...
# Interacting with your Flicker CL

Interaction with your transmitter is done via the companion app. To download the app follow the links below:

* [Google Play Store](https://play.google.com/store/search?q=CellLocate&c=apps)
* [Apple App Store](https://apps.apple.com/app/id1610872429)

From the app you can:

* View all connection data.
* View and graph various parameters of the unit including battery voltage, connection time, and more.
* Make configuration changes and upload to be taken by transmitter at next connection.
