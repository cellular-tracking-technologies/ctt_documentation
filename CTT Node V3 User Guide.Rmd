...
# Unboxing your CTT Node V3 (4 Watt Solar Panel Model)
...
# New Mid-2025 - 5 Watt Solar-Rechargeable Power Supply
...
## Original 4 Watt Solar Pack LED Status Lights (on back of solar-rechargeable battery supply)
...
## Powering up the 5 Watt Solar Pack
...
## Checking the battery status on the 5 Watt Solar Pack
...
## New 5 Watt Solar Pack LED Status Lights
...
If your station indicates you are running the Disk Image from July 2024 or later, then you have a compatible version. **For optimal performance, we recommend upgrading to the latest Disk Image (09-10-2024) when possible.** To upgrade, flash your Raspberry Pi with the newest Disk Image per the instructions [here](https://cellular-tracking-technologies.github.io/ctt_documentation/flashingComputeModule.html).
...
Your CTT Node V3 has a 16GB SD card pre-installed for backup storage, as well as for manual data collection and management. As you saw from photos in Section 2, it's now much easier to service the SD card on Node V3 compared to the previous version. **DO NOT EVER HOT SWAP THE SD CARD. You mush power down the device before inserting/removing the card, otherwise the Node can behave as if it's writing to the SD card, and not.**
