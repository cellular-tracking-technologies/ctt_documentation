...
# Unboxing your CTT Node V3 (4V Solar Panel Model)
...
# Unboxing your CTT Node V3 Solar-Rechargeable Power Supply
...
With the new 5V Solar Pack, the indicator lights on the back have changed. 

There is a `square light that indicates charging`. Charging can occur whether or not the unit is powered. 

There are `four circle lights`. The `rightmost light is the power indicator` (when the unit is on).
Together, the four circle lights are the `charge indicators` (when in charge indicator mode).
