...
![Sensor Station Account Login page](./_book/images/account-portal/login-screen.png)
...
![Sensor Station Account page](./_book/images/account-portal/home-screen.png)
...
* **My Stations** - View your SensorStations, this is the tab we are interested in
...
Click on the My Stations tab to go to your sensor station fleet.

## Fleet Dashboard {-}

![Fleet Dashboard](./_book/images/account-portal/fleet-dashboard.png)
...
![Fleet Overview](./_book/images/account-portal/account-fleet-overview.png)
...
![Sensor Stations Table](./_book/images/account-portal/sensor-station-table.png)
...
![Recent Checkins Table](./_book/images/account-portal/account-recent-checkins.png)
...
![Sensor Station Account page](./_book/images/account-portal/map-and-station-info.png)
...
![Power and System Charts](./_book/images/account-portal/power-and-system.png)
...
![Power and System Charts](./_book/images/account-portal/detection-activity.png)
...
![Upload Queue](./_book/images/account-portal/upload-queue.png)
...
![Stability chart](./_book/images/account-portal/stability.png)
...
![Checkins Table](./_book/images/account-portal/recent-checkins.png)
...
![Data Files](./_book/images/account-portal/data-files.png)
