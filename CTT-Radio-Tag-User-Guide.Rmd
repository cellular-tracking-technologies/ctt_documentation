...
BlūMorpho tags arrive attached to a panel strip inside a labeled tri-fold envelope. Current shipments do not include a retention strip.
...
![*Fig 1. The tri-fold envelope holding your BlūMorpho tags, with the panel strip and envelope labels shown.*](images/BluMorphoTrifoldExplain.png){#id .class width=50%}
