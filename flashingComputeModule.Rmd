...
[Download Current Stable Disk Image](https://d25eksygu9dzud.cloudfront.net/sensor-station/images/sensor-station.latest.xz) (**Version ID: 1.2.2 Updated: 2024-08-23**)

*This version is required if you are using the V3 version of the CTT Nodes, or the CTT BlūSeries Receiver.* **Note that you will also need to update your radio firmware to v4.0.0.** This is the default firmware for this disk image release. The radio firmware can now be updated directly from the LCD screen or the SensorStation Interface. **The Changelog can now be found here:** [changelog.json](https://github.com/cellular-tracking-technologies/sensor-station-software/blob/lts_24-06.iso/changelog.json)
