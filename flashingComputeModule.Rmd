...
10. Click the `OS` button and scroll down to the very bottom to `Use Custom`.

![](images/rpi-imager-2.x.x/select-disk-image.png){#id .class width=50%}

Click on it and choose the SensorStation image file you saved (it's a `.xz` file), and select it.

11. Click the button under `Storage` and select your Raspberry Pi compute module as the target. `example: RPi-MSGD-0001 (bootfs, rootfs), 29.1 GB`

![](images/rpi-imager-2.x.x/select-storage-device2.png){#id .class width=50%}
...
![](images/rpi-imager-2.x.x/write-image-1-percent.png){#id .class width=50%}
