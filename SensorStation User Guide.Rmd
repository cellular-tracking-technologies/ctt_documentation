...
3. Plug your power source wires into the power filter terminal, again ensuring that you're matching the polarity (positive with positive, negative with negative).
