...
# Appendix III: Latest Sensor Station Updates
...
for (version in c(1:2)){ # only show first three updates
...
## Full update changelog can be found [here.](CTT-Sensor-Station-Changelog.html)
