...
**V3 stations (or upgraded V2 stations):**
`scp -r ctt@10.1.10.113:/data c:/Users/joeschmoscomputer/Downloads`
...
`ssh ctt@169.254.237.56 "sudo rm -rf /data/uploaded/* && sudo rm -rf /data/rotated/* && sudo rm -rf /data/SGdata/* && sudo rm /data/*.csv"`
