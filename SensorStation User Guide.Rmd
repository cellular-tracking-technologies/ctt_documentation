...
3. **Request and install the new FREE PowerFilter** for reducing environmental noise [here](https://airtable.com/app20NXPv7qjXDfBN/pagrBcK1muqejz5os/form) pwd: `celltracktech2025`.
4. *Optional:* **set the reboot cycle to weekly**. This will ensure your station reboots more frequently which can reconnect any FCD that may have been kicked off due to overrunning the USB bus.
