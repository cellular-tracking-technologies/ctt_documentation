...
![U.FL jumper cable](/Users/davidlapuma/Library/CloudStorage/Dropbox/CTT_Git/ctt_documentation/images/cellboost_uflJumper.png){#id .class width="50%"}

![U.FL to SMA adapter cable](/Users/davidlapuma/Library/CloudStorage/Dropbox/CTT_Git/ctt_documentation/images/cellboost_uflToSmaAdapter.png){#id .class width="50%"}

![LTE modem with ports identified. Note that in this image the standard patch antenna that ships with the SensorStation is currently connected to the `main` port on the modem.](/Users/davidlapuma/Library/CloudStorage/Dropbox/CTT_Git/ctt_documentation/images/cellboost_modemPortID.png){#id .class width="50%"}
...
![To jump the `main` port on the LTE modem to the U.FL port at `J6` on the SensorStation board, first remove the antenna that comes with the SensorStation](/Users/davidlapuma/Library/CloudStorage/Dropbox/CTT_Git/ctt_documentation/images/cellboost_mainOpen.png){#id .class width="50%"}

![Option 1: LTE modem with jumper cable attaching `main` on the modem to `J6` on the SensorStation board, therefore activating the SMA port at `J7`. Now the Cell Booster antenna can be attached to the SMA port at `J7`](/Users/davidlapuma/Library/CloudStorage/Dropbox/CTT_Git/ctt_documentation/images/cellboost_uflJumperConnected.png){#id .class width="50%"}

![Option 2: LTE modem connected directly to U.FL to SMA adapter, which allows to connect directly to a Cell Booster antenna without using `J6` or `J7` on the board](/Users/davidlapuma/Downloads/cellboost_uflToSmaConnected.JPG){#id .class width="50%"}
...
**V3 stations (or upgraded V2 stations):**
...
**For V3 (and updated V2) Stations:**
...
4. On V2 or V3 stations, record the IP address from the LDC screen (under Network > IP Address)
