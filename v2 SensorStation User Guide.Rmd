...
*The default is `raspberry` but all 2022 stations have been changed to `ctt-sensor`. Note if `raspberry` works for you, you can change your password via the `raspi-config` you will access in the next step. Just choose `change password` instead of `Network Options` below.*
