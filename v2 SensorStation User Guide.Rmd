...
**Note: there are two known bugs in the USB manual download system. See the [Known Bugs](#known-bugs) section below. 
...
1. Download via USB does not include SensorGnome files. To get these files manually, use the direct-connect method via USB->Ethernet and access via the web interface.
2. Download via USB does not include any data previously uploaded remotely. To get these files manually, use the direct-connect method via USB->Ethernet and access via the web interface.
