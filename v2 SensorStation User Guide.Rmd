...
2. Download via USB does not include SensorGnome files, nor does it include any data previously uploaded remotely. To get these files manually, use the direct-connect method via USB->Ethernet and access via the web interface.
